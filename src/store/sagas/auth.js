...
// Generator: next generation function which can be executed incrementally
// yield: executed steps = execute this and wait for it to finish

export function* logoutSaga(action) {
  // yield localStorage.removeItem('token');
  // yield localStorage.removeItem('expirationDate');
  // yield localStorage.removeItem('userId');
  //// Helper qui permet de tester local storage with mock!
